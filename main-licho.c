...
void ordenMesa (Comida productos[],int size,Mesa *mesa);
...
int main ()
{
    ...
    if (nuevaMesa == 's')
    {
        ...
        ordenMesa(productos,productosCargados,&mesas[posMesa]);
...
void ordenMesa (Comida productos[],int size,Mesa *mesa)
{
    ...
    case 1:
        ...
        //mesa->pedidos[mesa->cantOrd]=productos[posProducto];
        temp.items[temp.cantItems] = productos[posProducto];
        temp.cantItems++;
    break;
    case 2:
        printf("Bebidas\n");
